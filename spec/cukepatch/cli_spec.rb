...
module CukePatch
  describe Cli do  
    it "should add the prioritised features before any other features" do
      ...
      extended_args = cli.extend_for_cukepatch(['joe.feature'])
    ...
    context "no formatter specified" do
      it "should add the pretty formatter" do
        ...
        cli.extend_for_cukepatch(["joe.feature"]).should include("pretty")
      end
    end
    ...
    context "a formatter is specified" do
      it "should not add the pretty formatter" do
        ...
        cli.extend_for_cukepatch(["joe.feature"]).should_not include("pretty")
      end
    end
  end
end